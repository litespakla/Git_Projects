...
number to be shown to require over fifty iterations before
...
#Counts how many lichel numbers are below a cetan limit after sime iterations
def lychrel(limit, iter):
    count=0
    for i in range(1, limit):
        number=i
        #Arter iter iterations, it's a lychrel number
        for j in range(iter):
